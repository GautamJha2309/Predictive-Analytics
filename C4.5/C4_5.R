...
split_info_age = -((count_age_1/count_TTL)*(log2(count_age_1/count_TTL)))-((count_age_2/count_TTL)*(log2(count_age_2/count_TTL)))-((count_age_3/count_TTL)*(log2(count_age_3/count_TTL)))
split_info_age

Gain_ratio_age = Gain_age/split_info_age
Gain_ratio_age
...
split_info_income = -((count_income_1/count_TTL)*(log2(count_income_1/count_TTL)))-((count_income_2/count_TTL)*(log2(count_income_2/count_TTL)))-((count_income_3/count_TTL)*(log2(count_income_3/count_TTL)))
split_info_income

Gain_ratio_income = Gain_income/split_info_income
Gain_ratio_income
...
split_info_student = -((count_student_1/count_TTL)*(log2(count_student_1/count_TTL)))-((count_student_2/count_TTL)*(log2(count_student_2/count_TTL)))
split_info_student

Gain_ratio_student = Gain_student/split_info_student
Gain_ratio_student
...
split_info_credit = -((count_credit_1/count_TTL)*(log2(count_credit_1/count_TTL)))-((count_credit_2/count_TTL)*(log2(count_credit_2/count_TTL)))
split_info_credit

Gain_ratio_credit = Gain_credit/split_info_credit
Gain_ratio_credit
...
max(c(Gain_ratio_credit, Gain_ratio_student, Gain_ratio_income, Gain_ratio_age))
